...
/**
 * Gemini CLI adapter — UserPromptSubmit hook.
 * Same stdin JSON protocol as Claude Code.
...
async function main() {
  ...
  try {
    ...
    const grammarFile = `/tmp/cc-grammar-gemini-status-${sessionId}.txt`;
    ...
    writeResult('/tmp/cc-grammar-gemini-status-default.txt', '');
  }
